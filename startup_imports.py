...
try:
    ...
    import io, sys, subprocess, shutil, warnings
...
# === MONKEY-PATCH EXTENSION: auto-tweak every figure & Ctrl+C clipboard ===

# ---------- clipboard helper ----------
def _copy_figure_to_clipboard(fig, dpi=300):
...
_orig_Figure_init = Figure.__init__
